...
date = 2015-01-06T19:30:00Z
title = "Como instalar o ArchLinux com LXDE"
imageLocal  = "/images/posts/como-instalar-o-arch-linux-com-lxde/banner-archlinux.jpg"
imageRemote = "https://gdurl.com/pS0k"
Comments = true
+++
...
<span class="red">__Obs:__</span> A instalação a seguir  e feita numa maquina real (não é maquina virtual) por causa disso a parte relacionada em conexão com a internet pode divergir de outros tutoriais.
...
<span class="red">__Atenção:__</span> a parte da instalação do Arch Linux é válida idependente da interface grafica a ser instalada.
...
{{% image local="/images/posts/como-instalar-o-arch-linux-com-lxde/archlinux.jpg" remote="https://gdurl.com/j82B" %}}
...
>  <span class="red">__Atenção__</span>: na hora no nome do profile, alguns teste que fiz quando se tem algum espaço entre as palavras dava um erro mais na frente dizendo que não encontrava o profile.
...
> <span class="red">__Atenção__</span>: se o seu HD nunca tiver sido usado, pode aparecer uma tela perguntando o tipo, caso isso aconteça escolha a opção "DOS".
...
{{% image local="/images/posts/como-instalar-o-arch-linux-com-lxde/startx.png" remote="https://gdurl.com/1IUb" %}}
